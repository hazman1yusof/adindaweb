				...
				<h4 class="ui dividing header">Shipping Information</h4>
				  ...
				  <div class="field">
				    ...
				    <div class="two fields">
				      <div class="field">
				        <input type="text" name="f_name" placeholder="First Name" value="{{$user->f_name}}">
				      </div>

				      <div class="field">
				        <input type="text" name="l_name" placeholder="Last Name" value="{{$user->l_name}}">
				      </div>
				    ...
				    <div class="fields">
				      ...
				      <div class="twelve wide field">
				    	<label>Billing Address</label>
				      	<textarea placeholder="Address" rows="4" name="address" >{{$user->address}}</textarea>
				      </div>
				  ...
				  <div class="eight wide field">
					  ...
					  <div class="ui left labeled input">
						  ...
						  <input type="text" name="mobile_nm" placeholder="Phone Number" value="{{$user->mobile_nm}}">
						</div>
				  </div>
